...
class Calculator {
 public:
  ...
  // Cálculo
  BigInt<Base> EvaluateExpression();
 private:
...
/**
 * Método auxiliar para resolver la estructura switch
 */
 ...
 * @brief Permite elvaluar una expresión, expresada en notación polaca
 */
template<size_t Base>
BigInt<Base> Calculator<Base>::EvaluateExpression() {
